...
- ✅ **Персистентность индексов** - данные не теряются при перезапуске
- ✅ **Фильтрация по метаданным** - поиск по тегам, авторам, времени
- ✅ **Автоматическая классификация** - определение типа контента и тегов
- ✅ **NER (Named Entity Recognition)** - извлечение организмов, локаций, экосистем
- ✅ **Локализация экосистем** - привязка геолокации к сессиям чата для персонализированных ответов
- ✅ **База симбионтов и патогенов** - иерархическая структура микроорганизмов с поиском и анализом
- ✅ **AutoSchema** - схема базы данных эволюционирует органически
- ✅ **Масштабируемость** - поддержка больших объемов данных
- ✅ **GraphQL API** - мощный язык запросов
- ✅ **Векторный поиск** - семантический поиск по контенту

## 📚 Документация

- [Обзор архитектуры](docs/README.md)
- [Локализация экосистем](docs/features/SESSION_LOCALIZATION.md)
- [Накопление знаний](docs/features/WEAVIATE_KNOWLEDGE_ACCUMULATION.md)
- [Пользовательские функции поиска](docs/features/SEARCH_USER_FEATURES.md)
