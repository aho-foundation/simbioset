    ...
    <div class={styles.container}>
      ...
      <section class={styles.features}>
        <div class={styles.featuresGrid}>
          ...
          <div class={styles.featureCard}>
            <div class={styles.featureIcon}>🤝</div>
            <h3 class={styles.featureTitle}>{t('Самоорганизация и соучастие')}</h3>
            <p class={styles.featureDescription}>
              {t(
                'Платформа для совместной работы волонтеров и ученых. Создание сообществ, распределенное принятие решений и коллективное управление проектами'
              )}
            </p>
          </div>
        </div>
